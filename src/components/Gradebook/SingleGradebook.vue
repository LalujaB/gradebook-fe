<template>
  <div class="container">
    <h1>Single Gradebook</h1>
    <table class="table table-striped table-bordered">
      <thead class="thead-dark">
        <tr>
          <th>
            <router-link class="btn btn-md btn-primary" v-if="user" :to="{ name: 'add-student', params: { id: diary.id }}" style="min-width: 160px;">Add Student</router-link>
          </th>
          <th>Gradebook</th>
          <th>Professor</th>
          <th>Students</th>
